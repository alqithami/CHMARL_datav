...
const chmarlState = { source: CHMARL_EXPERIMENT_URL ? "url" : "file", configuredUrl: Boolean(CHMARL_EXPERIMENT_URL), file: CHMARL_EXPERIMENT_FILE, steps: 0, experimentId: null, scenarioId: null, lastLoadedAt: null, lastIngestedAt: null, lastError: null };
...
function readChmarlFilePayload() { if (!existsSync(CHMARL_EXPERIMENT_FILE_PATH)) return null; return JSON.parse(readFileSync(CHMARL_EXPERIMENT_FILE_PATH, "utf8")); }
